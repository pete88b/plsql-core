...
/*
  Drop script for event mediator.
*/

PROMPT ___ Start of event mediator drop.sql ___
...
BEGIN
  drop_object('PACKAGE event_mediator');
  drop_object('TABLE event_mediator_data');

END;
/

PROMPT ___ End of event mediator drop.sql ___