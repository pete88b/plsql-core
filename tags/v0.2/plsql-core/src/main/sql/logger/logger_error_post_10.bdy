...
IS
  ...
  /*
    ...
    This is the default implementation of logger_error for post 10g databases.
  */  
  ...
  /*
    ...
    This procedure will save the error backtrace - it is not possible to get 
    the error backtrace in pre 10g databases.
  */
  PROCEDURE log (
