...
declare
  ...
  exception
    when others
    then
      logger.error('logger_error_pre_10.a');
  ...
  begin
    ...
    select null into l_dummy
     ...
     where log_date between (p_log_date - (24/60/60)) and (p_log_date + (24/60/60))
       ...
       and (error_message = p_error_message or (error_message is null and p_error_message is null))
       and (error_backtrace = p_error_backtrace or (error_backtrace is null and p_error_backtrace is null));
...
begin
  ...
  a(1);
  assert_row_exists(
    'logger_error_pre_10.a',    -- p_log_data
    null,                       -- p_module_owner
    null,                       -- p_module_name  
    28,                         -- p_module_line 
