...
/*
  Drop script for permissions.
*/

PROMPT ___ Start of permissions drop.sql ___
...
BEGIN
  drop_object('PACKAGE permission');
  drop_object('PACKAGE permissions');
...
PROMPT ___ End of permissions drop.sql ___
