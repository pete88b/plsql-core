...
/*
  Drop script for direct_access.
*/

PROMPT ___ Start of direct_access drop.sql ___
...
BEGIN
  drop_object('PACKAGE direct_access');
  
END;
/

PROMPT ___ End of direct_access drop.sql ___
