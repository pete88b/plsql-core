/*
  tests the default logger implementation
*/
...
BEGIN
  ...
  */
  ...
  logger.exiting('test_module_name', 89);
  ROLLBACK;
  assert_log_exists('feedback', 99, 'test_module_name RETURN=89', NULL);
  ...
  logger.exiting('test_module_name', 'test return value');
  assert_log_exists('feedback', 99, 'test_module_name RETURN=test return value', NULL);
